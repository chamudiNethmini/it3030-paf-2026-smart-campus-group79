    ...
    <>
      ...
      <div className="manage-bookings-page">
        <div className="manage-bookings-container">
          ...
          <p className="manage-bookings-subtitle page-subtitle">
          ...
          <section className="table-intro">
            ...
            <p className="table-intro-subtitle">
              Approve or reject pending requests from here.
            </p>

            <ul className="status-legend">
              <li><span className="dot pending" /> Pending</li>
              <li><span className="dot approved" /> Approved</li>
              <li><span className="dot rejected" /> Rejected</li>
              <li><span className="dot cancelled" /> Cancelled</li>
            </ul>
          </section>
